...
if __name__ == '__main__':
    csv_file = "./iphd_good_train_thermal.csv"
    image_dir = "E:/paper/data/iphd_train_thermal-v2/images/"
    saved_coco_path = "./"
    # 整合csv格式标注文件
    ...
    #train_keys, val_keys = train_test_split(total_keys, test_size=1)
